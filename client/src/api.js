...
const base_url = "codecaptureapi.vercel.app";
...
async function login(loginDetails) {
  const res = await axiosinstance.post(
    "codecaptureapi.vercel.app/login",
    loginDetails
  );
  return res;
}
...
async function getallproblems(problemDetails) {
  const res = await axiosinstance.post(
    "codecaptureapi.vercel.app/feed",
    problemDetails
  );
  return res;
}
...
async function getProblemDetails(problemDetails) {
  const res = await axiosinstance.post(
    "codecaptureapi.vercel.app/problem/content",
    problemDetails
  );
  return res;
}
...
async function getOcr(imageDetails) {
  ...
  const key = process.env.SERN_API;
  ...
  const ocrRes = await axiosinstance
    .post("codecaptureapi.vercel.app/problem/ocr", {
...
async function runCode(codeDetails) {
  const res = await axiosinstance
    .post("codecaptureapi.vercel.app/problem/run", codeDetails)
    .catch((err) => {
      return err;
    });
  return res;
...
async function runCodeStatus(codeDetails) {
  const res = axiosinstance
    .post("codecaptureapi.vercel.app/problem/runStatus", codeDetails)
    .catch((err) => {
      return err;
    });
  return res;
...
async function submitCodeApi(submitCodeDetails) {
  ...
  const res = await axiosinstance
    .post("codecaptureapi.vercel.app/problem/submit", submitCodeDetails)
    .catch((err) => {
      return err;
    });
  return res;
...
async function submitCodeStatusApi(submitCodeDetails) {
  const res = await axiosinstance
    .post("codecaptureapi.vercel.app/problem/submitStatus", submitCodeDetails)
    .catch((err) => {
      return err;
    });
  return res;
...
async function getEditorData(problemDetails) {
  const res = await axiosinstance.post("codecaptureapi.vercel.app/problem/editor", problemDetails)
    .catch((err) => {
      console.log(err);
      return err;
    });
...
async function getTestCaseData(problemDetails) {
  const res = await axiosinstance.post("codecaptureapi.vercel.app/problem/testcase", problemDetails)
    .catch((err) => {
      console.log(err);
      return err;
    });
